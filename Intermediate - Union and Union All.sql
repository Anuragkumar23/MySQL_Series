...
-- notice it gets rid of duplicates? Union is actually shorthand for Union Distinct(by default Union is distinct)
...
SELECT first_name, last_name
FROM employee_data
UNION ALL                 -- Union All keeps duplicates also
SELECT first_name, last_name
FROM employee_salary;


#Now Let's actually try to use UNION
# The Employee department is trying to cut their budget and wants to identify older employees they can push out or high paid employees who they can reduce pay or push out
